		...
		<div class="sidebar inner">
			<div class="sb_nav">
				...
				<div class="active" id="sidebar" data-csnow="2" data-class3="0" data-jsok="2">
					<c:forEach items="${associationInfoList}" var="ai">
						<dl class="list-none navnow">
							<dt id='part2_4'>
								<a href='queryByIdAssociationInfo?id=${ai.id}' title='${ai.name}' class="zm"><span>${ai.name}</span></a>
							</dt>
						</dl>
					</c:forEach>
			...
			<div class="sb_box">
				...
				<div class="active" id="shownews">
					...
					<div class="editor">
						<img alt="${associationInfo.name}" src="getInfoPhoto?id=${associationInfo.id}" width="100%"/>
						<div class="clear"></div>
					</div>
				</div>
			</div>
