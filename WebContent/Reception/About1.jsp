			...
			<div class="sb_nav">
				...
				<div class="active" id="sidebar" data-csnow="2" data-class3="0" data-jsok="2">
					<dl class="list-none navnow">
						<dt id='part2_4'>
							<a href='About1.jsp' title='协会介绍 ' class="zm"><span>协会介绍</span></a>
						</dt>
					</dl>
					<dl class="list-none navnow">
						<dt id='part2_5'>
							<a href='About2.jsp' title='部门介绍' class="zm"><span>部门介绍</span></a>
						</dt>
					</dl>
					<dl class="list-none navnow">
						<dt id='part2_5'>
							<a href='About3.jsp' title='规章制度' class="zm"><span>规章制度</span></a>
						</dt>
					</dl>
					<dl class="list-none navnow">
						<dt id='part2_5'>
							<a href='About4.jsp' title='假期远征' class="zm"><span>假期远征</span></a>
						</dt>
					</dl>
					<dl class="list-none navnow">
						<dt id='part2_5'>
							<a href='About5.jsp' title='荣誉殿堂' class="zm"><span>荣誉殿堂</span></a>
						</dt>
					</dl>
					<dl class="list-none navnow">
						<dt id='part2_5'>
							<a href='About6.jsp' title='合作伙伴' class="zm"><span>合作伙伴</span></a>
						</dt>
					</dl>
			...
			<div class="sb_box">
				<h3 class="title">
					<div class="position">
							...
							<a href="About1.jsp">关于我们</a> >&nbsp;协会介绍
					</div>
					<span>关于我们</span>
				</h3>
				<div class="clear"></div>
				<div class="active" id="shownews">
					<h1 class="title">协会介绍</h1>
					<div class="editor">
						<div>
							<div>&nbsp; &nbsp;
		...
		<footer data-module="10001" data-classnow="10001">
			<div class="inner">
				<div class="foot-nav">
					...
					<a href="queryDailyActivity" title="下载中心">下载中心</a><span>|</span>
