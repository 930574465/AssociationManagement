...
<html lang="zh-CN">
	...
	<body>
			...
			<div class="inner">
				...
				<nav>
					<ul class="list-none">
						...
						<li class="line"></li>
						<li id="nav_22" style="width: 139px; border-top-right-radius: 5px;" data-corner="tr 5px" ><a href="queryAllContactActiion2" class="hover-none nav"><span>联系我们</span></a></li>
					</ul>
				</nav>
			</div>
		</header>
		...
		<div class="sidebar inner ">
		    <div class="sb_box1">
			    <h3 class="title">
					<div class="position">当前位置：<a href="../index.jsp" title="网站首页">网站首页</a> &gt; &nbsp;登录</div>
					<span>登录</span>
				</h3>
					
					<div align="center">
						<form name="reg" action="loginUser" method="post" onSubmit="return docheck()">
							<table width="30%" border="0">
								<caption>成员登录</caption>
								<tr>
									<td width="25%" align="right" height="25">学号：</td>
									<td width="75%" align="left" height="25"><input type="text" name="number">
								</tr>
								<tr>
							...
							<p>
								<c:if test="${!empty loginError}">
									<font color="red">学号或密码错误</font><br/>
								</c:if>
