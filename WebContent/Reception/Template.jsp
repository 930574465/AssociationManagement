			...
			<div class="sb_box1">
				<h3 class="title">
					<div class="position">
							...
							<a href="queryByPageNotice2<c:if test="${empty loginedUser}">?permission=0</c:if>">车协公告</a> >&nbsp;aaa
						</div>
					<span>车协公告</span>
				</h3>
				<div class="clear"></div>
				<div class="active" id="shownews">
					<h1 class="title">${queryNotice.title}</h1>
					<div class="editor">
					...
					<div class="met_hits">
						点击次数：<span>${queryNotice.clicks}</span>&nbsp;&nbsp;更新时间：${queryNotice.date}&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
				</div>
			</div>
			<div class="clear"></div>
